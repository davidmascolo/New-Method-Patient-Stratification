...
id_patients <- data.frame(t(read.table(paste0(path_breast,
                                              "id_Breast_patients.txt"),
                          sep = "")))
...
df_clinical <- GDCquery_clinic(project = "TCGA-BRCA",
                               type = "clinical")
## Check
dim(df_clinical)
...
## Save output
write.csv(df_clinical, "C:/Users/david/Documents/Conferences/To_Do/EMBC_2024/Personal/Code/BREAST/Data/BREAST_Clinical.csv")
write.csv(id_patients_clean, "C:/Users/david/Documents/Conferences/To_Do/EMBC_2024/Personal/Code/BREAST/Data/Id_BREAST_patients.csv",
          row.names = F)
...
## Path
data_path <- "C:/Users/david/Documents/Conferences/To_Do/EMBC_2024/Personal/Code/COLON/Data/"
res_path  <- "C:/Users/david/Documents/Conferences/To_Do/EMBC_2024/Personal/Code/COLON/Res/"

## Load data
COLON_Survival <- read.delim(paste0(data_path, "COLON_Survival.txt"), header = T)
COLON_Survival$PatientIDModified <- gsub("TCGA-([0-9]{2})-([0-9]{4}).*",
                                          "\\1.\\2", COLON_Survival$PatientID)
id <- COLON_Survival
## Extract data
...
run_kruskal_test("Ajcc_Pathologic_T", df_patients)
...
(p2 <- ggplot(df_patients, aes(x = Subtype,
    ...
    scale_fill_manual(values = c("Adenocarcinoma with neuroendocrine differentiation" ="#F8766D",
                                 "Adenocarcinoma, NOS"= "#D39200",
                                 "Adenosquamous carcinoma" = "#93AA00",
                                 "Carcinoma, NOS" = "#00BA38",
                                 "Mucinous adenocarcinoma" = "#00C19F"),

...
id_patients <- data.frame(t(read.table(paste0(path_colon,
                                              "id_Colon_patients.txt"),
                                       sep = "")))
...
df_clinical <- GDCquery_clinic(project = "TCGA-COAD",
                               type = "clinical")
## Check
dim(df_clinical)
...
## Save output
write.csv(df_clinical, "C:/Users/david/Documents/Conferences/To_Do/EMBC_2024/Personal/Code/COLON/Data/COLON_Clinical.csv")
write.csv(id_patients_clean, "C:/Users/david/Documents/Conferences/To_Do/EMBC_2024/Personal/Code/COLON/Data/Id_COLON_patients.csv",
          row.names = F)
